...
Game::Game(Reader * reader, GTKController * control)
	...
	m_Button_Selection3("Select Option 3")
{
	...
	m_Button_Quit.signal_clicked().connect(sigc::mem_fun(*this, &Game::on_button_quit) );
	
	m_Button_Selection1.signal_clicked().connect(sigc::mem_fun(*this, &Game::on_button_selection1) );
	
	m_Button_Selection2.signal_clicked().connect(sigc::mem_fun(*this, &Game::on_button_selection2) );

	m_Button_Selection3.signal_clicked().connect(sigc::mem_fun(*this, &Game::on_button_selection3) );
	
	m_Button_Restart.signal_clicked().connect(sigc::mem_fun(*this, &Game::on_button_restart) );
...
void Game::on_button_quit() {
	hide();
}

void Game::on_button_restart() {
	_reader->restart();
	_reader->read();
	m_refTextBuffer->set_text(_reader->getText());
}

void Game::on_button_selection1() {	
...
void Game::on_button_selection2() {
...
void Game::on_button_selection3() {
